...
require('lazy').setup({
    ...
    {import = 'custom.plugins.gitsigns'}, {import = 'custom.plugins.lualine'},
    {import = 'custom.plugins.mkdir'}, {import = 'custom.plugins.neotree'},
    {import = 'custom.plugins.projects'}, {import = 'custom.plugins.todo'},
    {import = 'custom.plugins.toggleterm'}, {import = 'custom.plugins.trouble'},
